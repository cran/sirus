...
// rangerMergeCpp
Rcpp::List rangerMergeCpp(int numTrees, std::vector<std::vector<std::vector<double> > > paths1, std::vector<int> proba1, std::vector<std::vector<std::vector<double> > > paths2, std::vector<int> proba2);
RcppExport SEXP _sirus_rangerMergeCpp(SEXP numTreesSEXP, SEXP paths1SEXP, SEXP proba1SEXP, SEXP paths2SEXP, SEXP proba2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type numTrees(numTreesSEXP);
    Rcpp::traits::input_parameter< std::vector<std::vector<std::vector<double> > > >::type paths1(paths1SEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type proba1(proba1SEXP);
    Rcpp::traits::input_parameter< std::vector<std::vector<std::vector<double> > > >::type paths2(paths2SEXP);
    Rcpp::traits::input_parameter< std::vector<int> >::type proba2(proba2SEXP);
    rcpp_result_gen = Rcpp::wrap(rangerMergeCpp(numTrees, paths1, proba1, paths2, proba2));
    return rcpp_result_gen;
END_RCPP
}
// stabilityMetricCpp
Rcpp::NumericVector stabilityMetricCpp(int numTrees, std::vector<double> proba);
RcppExport SEXP _sirus_stabilityMetricCpp(SEXP numTreesSEXP, SEXP probaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type numTrees(numTreesSEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type proba(probaSEXP);
    rcpp_result_gen = Rcpp::wrap(stabilityMetricCpp(numTrees, proba));
    return rcpp_result_gen;
END_RCPP
}
// numSmaller
Rcpp::IntegerVector numSmaller(Rcpp::NumericVector values, Rcpp::NumericVector reference);
RcppExport SEXP _sirus_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_sirus_rangerCpp", (DL_FUNC) &_sirus_rangerCpp, 42},
    {"_sirus_rangerMergeCpp", (DL_FUNC) &_sirus_rangerMergeCpp, 5},
    {"_sirus_stabilityMetricCpp", (DL_FUNC) &_sirus_stabilityMetricCpp, 2},
    {"_sirus_numSmaller", (DL_FUNC) &_sirus_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_sirus(DllInfo *dll) {
